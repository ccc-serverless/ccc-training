...
export default function PreAssessmentIndex() {
  ...
  async function getQuestions() {
    ...
    return new Promise((resolve, reject) => {
      getRequest(
        `/assessment/chapter/questions?courseId=${allocatedCourse.courseId}&moduleUid=${params.moduleUid}&assessmentType=pre-chapter`
      )
        .then((resp) => {
  ...
  return (
    <Assessment type="pre-chapter" getQuestions={getQuestions} postResult={postResult} />
  );
}
